...
namespace AJM.Common
{
    ...
    public class MailHelper
    {
        ...
        /// 发送给
        /// </summary>
        private static readonly string ErrorReportTo = ConfigHelper.GetValue("ErrorReportTo");
        /// <summary>
        /// 邮件服务器地址
        /// </summary>
        ...
        static MailHelper()
        {
            ...
            //保存静态文件的路径
            string realPath = CommonHelper.GetBaseDirectory(templatePath);
        ...
        public static bool Send(string subject, string body, string to = "", string encoding = "UTF-8", bool isBodyHtml = true, bool enableSsl = true)
        {
            try
            {
        ...
        /// <param name="enableSsl">是否SSL加密连接</param>
        /// <returns>是否成功</returns>
        public static void SendByThread(string subject, string body, string to = "", string encoding = "UTF-8", bool isBodyHtml = true, bool enableSsl = true)
        {
